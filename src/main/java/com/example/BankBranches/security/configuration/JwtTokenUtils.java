...
public class JwtTokenUtils {
    ...
    public String getToken(AppUser appUser) throws JOSEException {
        ...
        claims.claim("email", appUser.getEmail())
                .build();
        claims.claim("password", appUser.getPassWord()).build();
    ...
    public String parseToken(String token) throws ParseException, BadJOSEException, JOSEException {
